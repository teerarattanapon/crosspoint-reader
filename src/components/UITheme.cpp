...
#include "components/themes/catpose/CatPoseTheme.h"
...
void UITheme::setTheme(CrossPointSettings::UI_THEME type) {
  switch (type) {
    ...
    case CrossPointSettings::UI_THEME::LYRA_3_COVERS:
      ...
      break;
    case CrossPointSettings::UI_THEME::CAT_POSE:
      LOG_DBG("UI", "Using CatPose theme");
      currentTheme = std::make_unique<CatPoseTheme>();
      currentMetrics = &CatPoseMetrics::values;
      break;
  }
}
